...
import impressiumHeroImgMob from '/public/images/uberuns-page/uberuns-hero-mob.jpg';
import impressiumHeroImgDesk from '/public/images/uberuns-page/uberuns-hero-desc.jpg';
